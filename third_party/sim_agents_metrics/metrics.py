...
from third_party.sim_agents_metrics import estimators
...
def load_metrics_config() -> sim_agents_metrics_pb2.SimAgentMetricsConfig:
  ...
  # pyformat: disable
  config_path = '{pyglib_resource}third_party/sim_agents_metrics/challenge_config.textproto'.format(pyglib_resource='')

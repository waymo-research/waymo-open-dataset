...
#ifndef WAYMO_OPEN_DATASET_MATH_EXACTFLOAT_H_
#define WAYMO_OPEN_DATASET_MATH_EXACTFLOAT_H_
...
class ExactFloat {
 public:
  ...
  // "long long", or "uint64", since these types are not typically
 ...
 protected:
  ...
  static const int kExpNaN = INT_MAX;
  static const int kExpInfinity = INT_MAX - 1;
  static const int kExpZero = INT_MAX - 2;
...
#endif  // WAYMO_OPEN_DATASET_MATH_EXACTFLOAT_H_
